        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <span className="text-2xl font-bold">Predictra</span>
            </div>
            <p className="text-slate-400 mb-6 max-w-md">
              AI-powered predictive maintenance platform designed to help small and mid-sized manufacturers prevent downtime and optimize operations.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-slate-800 rounded-lg flex items-center justify-center hover:bg-purple-600 transition-colors duration-200">
        ...
        <div className="pt-8 border-t border-slate-800">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-slate-400 text-sm">
              © {new Date().getFullYear()} Predictra. Built with ❤️ by Emerson, Arjan, Daniel, and Justin.
            </p>
